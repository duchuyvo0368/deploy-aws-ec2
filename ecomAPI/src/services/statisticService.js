                ...
                if (statusOrder) {
                    ...
                    orderProduct = orderProduct.filter((item) => {
                        if (data.type == 'day') {
                            ...
                            // Validate date inputs before using moment
                            if (!data.twoDate || !data.oneDate) {
                                return false;
                            }
                            ...
                            // Validate date input before using moment
                            if (!data.oneDate) {
                                return false;
                            }
...
let getStatisticStockProduct = (data) => {
    return new Promise(async (resolve, reject) => {
        try {
            let objectFilter = {
                include: [{ model: db.AllCode, as: 'sizeData', attributes: ['value', 'code'] }],
                raw: true,
                nest: true,
            };
