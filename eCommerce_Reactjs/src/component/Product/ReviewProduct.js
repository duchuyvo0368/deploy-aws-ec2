        ...
        <div className="row">
                            ...
                            <ul className="list">
                                <li>
                                    <a href="#">
                                        ...
                                        <i className="fa fa-star" />
                                        <i className="fa fa-star" />
                                        <i className="fa fa-star" /> Has{' '}
                                        {inputValues.countStar.star5} reviews
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <i className="fa fa-star" />
                                        <i className="fa fa-star" /> Has{' '}
                                        {inputValues.countStar.star4} reviews
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <i className="fa fa-star" />
                                        <i className="fa fa-star" /> Has{' '}
                                        {inputValues.countStar.star3} reviews
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <i className="fa fa-star" />
                                        <i className="fa fa-star" /> Has{' '}
                                        {inputValues.countStar.star2} reviews
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        1
                                        <i className="fa fa-star" /> Has{' '}
                                        {inputValues.countStar.star1} reviews
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            {inputValues.isOpen === true && (
                <Lightbox
                    ...
                    onCloseRequest={() =>
                        setInputValues({ ...inputValues, isOpen: false, imageReview: '' })
                    }
                />
            )}
            <ReviewModal
