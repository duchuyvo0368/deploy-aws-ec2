...
function OrderHomePage(props) {
        ...
        if (!dataTypeShip.id) {
            ...
            if (activeTypePayment == 0) {
                let res = await createNewOrderService({
                    ...
                    isPaymentOnline: activeTypePayment === 1 ? 1 : 0,
    ...
    //alert(JSON.stringify(dataVoucher))
    return (
        <>
                                ...
                                <>
                                    ...
                                    <div className="content-center">
                                        <span>
                                            {dataAddressUser &&
                                                dataAddressUser.length > 0 &&
                                                dataAddressUser[stt].shipAddress}
                                        </span>
                                    </div>
                                </>
                            ) : (
                                            ...
                                            return (
                                                <div key={index} className="form-check ">
                                                    <input
                                                        ...
                                                        checked={
                                                            item.id === addressUserId ? true : false
                                                        }
                                                        onChange={() =>
                                    ...
                                    <div className="wrap-voucher">
                                        ...
                                        {dataVoucher && dataVoucher.voucherData && (
                                            <span className="choose-voucher">
                                                Voucher code: {dataVoucher.voucherData.codeVoucher}
                                            </span>
                                        )}
                                    </div>
                                ...
                                <div className="content-right">
                                    <div className="wrap-price">
                                        <span className="text-total">
                                            Total payment ({dataCart && dataCart.length} products):{' '}
                                        </span>

                                        <span className="text-price">
                                            {dataVoucher && dataVoucher.voucherData
                                                ? CommonUtils.formatter.format(
                                                      totalPriceDiscount(price, dataVoucher) +
                                                          priceShip,
                                                  )
